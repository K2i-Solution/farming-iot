...
using Shouldly;
using Xunit;
using K2iSolution.AquaFarmingIoT.Sessions;

namespace K2iSolution.AquaFarmingIoT.Tests.Sessions
{
    public class SessionAppService_Tests : AquaFarmingIoTTestBase
    {
