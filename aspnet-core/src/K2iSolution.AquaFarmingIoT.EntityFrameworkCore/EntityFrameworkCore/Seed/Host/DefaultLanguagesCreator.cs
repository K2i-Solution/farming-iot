...
namespace K2iSolution.AquaFarmingIoT.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AquaFarmingIoTConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AquaFarmingIoTDbContext context)
        {
            _context = context;
        }
